...
class mydsp_poly : public dsp_voice_group, public dsp_poly {
    ...
    public:
        ...
        void setParamValue(int id, const std::string& path, FAUSTFLOAT value)
        {
            fVoiceTable[id]->setParamValue(path, value);
        }
...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider5 = FAUSTFLOAT(0.90000000000000002f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("bend", &fHslider7, 0.0f, -2.0f, 2.0f, 0.00999999978f);
		ui_interface->declare(&fHslider5, "2", "");
		ui_interface->declare(&fHslider5, "style", "knob");
		ui_interface->addHorizontalSlider("gain", &fHslider5, 0.899999976f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->declare(&fHslider3, "3", "");
		ui_interface->declare(&fHslider3, "style", "knob");
		ui_interface->addHorizontalSlider("envAttack", &fHslider3, 1.0f, 0.0f, 30.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow0 = (0.100000001f * float(fHslider0));
		...
		float fSlow6 = std::min<float>(1.0f, (float(fButton0) + float(fHslider4)));
		float fSlow7 = ((fSlow6 * float(fHslider5)) * (1.0f - fSlow5));
		float fSlow8 = (340.0f / float(fHslider6));
		int iSlow9 = (fSlow6 == 0.0f);
		float fSlow10 = std::pow(2.0f, (0.0833333358f * float(fHslider7)));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fVec0[0] = fSlow6;
			fRec24[0] = ((fRec24[1] * fSlow5) + fSlow7);
			...
			float fTemp0 = float(((fSlow6 == fVec0[1]) | iSlow9));
			fRec29[0] = ((0.999000013f * (fTemp0 * fRec29[1])) + (fSlow10 * (1.0f - (0.999000013f * fTemp0))));
			float fTemp1 = ((fSlow8 / fRec29[0]) + 0.270000011f);
			fRec30[0] = (fSlow11 + (0.999000013f * fRec30[1]));
			...
			fVec1[0] = (((((fRec28[((IOTA - iTemp6) & 2047)] * fTemp9) * fTemp11) * fTemp13) * fTemp15) + (fTemp16 * ((((((fRec28[((IOTA - iTemp17) & 2047)] * fTemp18) * fTemp19) * fTemp20) + (0.5f * (((fTemp8 * fRec28[((IOTA - iTemp21) & 2047)]) * fTemp22) * fTemp23))) + (0.166666672f * ((fTemp24 * fRec28[((IOTA - iTemp25) & 2047)]) * fTemp26))) + (0.0416666679f * (fTemp27 * fRec28[((IOTA - iTemp28) & 2047)])))));
			float fTemp29 = (((fSlow1 * ftbl0mydspSIG0[int((65536.0f * fRec23[0]))]) + (fRec24[0] * ((fConst5 * (fRec25[2] + (fRec25[0] + (2.0f * fRec25[1])))) + 1.0f))) - (0.5f * fVec1[1]));
			float fTemp30 = ((0.5f * fRec7[1]) + std::max<float>(-1.0f, std::min<float>(1.0f, (fTemp29 * (mydsp_faustpower2_f(fTemp29) + -1.0f)))));
			fVec2[(IOTA & 2047)] = fTemp30;
			...
			fVec3[0] = (((((fVec2[((IOTA - iTemp34) & 2047)] * fTemp37) * fTemp39) * fTemp41) * fTemp43) + (fTemp44 * ((((((fVec2[((IOTA - iTemp45) & 2047)] * fTemp46) * fTemp47) * fTemp48) + (0.5f * (((fTemp36 * fVec2[((IOTA - iTemp49) & 2047)]) * fTemp50) * fTemp51))) + (0.166666672f * ((fTemp52 * fVec2[((IOTA - iTemp53) & 2047)]) * fTemp54))) + (0.0416666679f * (fTemp55 * fVec2[((IOTA - iTemp56) & 2047)])))));
			fRec20[0] = fVec3[1];
			float fRec16 = fRec19;
			float fRec17 = fRec20[0];
			float fRec18 = fRec20[0];
			fRec11[(IOTA & 2047)] = fRec16;
			float fRec12 = (((((fTemp37 * fTemp39) * fTemp41) * fTemp43) * fRec11[((IOTA - iTemp34) & 2047)]) + (fTemp44 * ((((((fTemp46 * fTemp47) * fTemp48) * fRec11[((IOTA - iTemp45) & 2047)]) + (0.5f * (((fTemp36 * fTemp50) * fTemp51) * fRec11[((IOTA - iTemp49) & 2047)]))) + (0.166666672f * ((fTemp52 * fTemp54) * fRec11[((IOTA - iTemp53) & 2047)]))) + (0.0416666679f * (fTemp55 * fRec11[((IOTA - iTemp56) & 2047)])))));
			float fRec13 = fRec17;
			float fRec14 = fRec18;
			fRec7[0] = fRec12;
			float fRec8 = fRec7[1];
			...
			float fRec4 = (((((fTemp9 * fTemp11) * fTemp13) * fTemp15) * fRec3[((IOTA - iTemp6) & 2047)]) + (fTemp16 * ((((((fTemp18 * fTemp19) * fTemp20) * fRec3[((IOTA - iTemp17) & 2047)]) + (0.5f * (((fTemp8 * fTemp22) * fTemp23) * fRec3[((IOTA - iTemp21) & 2047)]))) + (0.166666672f * ((fTemp24 * fTemp26) * fRec3[((IOTA - iTemp25) & 2047)]))) + (0.0416666679f * (fTemp27 * fRec3[((IOTA - iTemp28) & 2047)])))));
			float fRec5 = fRec9;
			float fRec6 = fRec10;
			fRec1[0] = fRec4;
			fRec2[0] = fRec6;
...
Flute::Flute(int sample_rate, int buffer_size)
{
    fUI = new MapUI();
...
void Flute::setParamValue(int id, const std::string& path, float value)
{
#ifdef NVOICES
    static_cast<mydsp_poly*>(fDSP)->setParamValue(id, path, value);
#else
...
void Flute::keyOn(uint8_t channel, uint8_t key, uint8_t vel)
{
    fMIDIHandler->handleKeyOn(0, channel, key, vel);
}

void Flute::keyOff(uint8_t channel, uint8_t key, uint8_t vel)
{
